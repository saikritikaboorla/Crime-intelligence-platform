...
export interface Message {
  ...
  /** 0–100 confidence that the answer is grounded in CSV records */
  confidence?: number;
  /** Short tag e.g. "Grounded in 4 FIR records" */
  groundingBasis?: string;
  /** Expandable path of tables/fields used to build the answer */
